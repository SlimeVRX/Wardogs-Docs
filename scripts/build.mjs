...
const header=prefix=>`<header class="masthead"><div class="brand">WARDOGS DOCS<span>Cẩm nang Gun Gameplay · tiếng Việt · 24.09.2026</span></div><div class="actions"><a href="${prefix}index.html">Cẩm nang</a><a href="${prefix}references.html">Báo cáo & bằng chứng</a><a href="https://github.com/SlimeVRX/Wardogs-Docs">GitHub ↗</a><button class="print" onclick="window.print()">In / lưu PDF</button></div></header>`;
function page(title,body,prefix='',script=''){return`<!doctype html><html lang="vi"><head><meta charset="utf-8"><meta name="viewport" content="width=device-width,initial-scale=1"><meta name="color-scheme" content="light"><meta name="description" content="Báo cáo hiệu chỉnh AK74, nền tảng Gun Gameplay và quy trình tái tạo cảm giác bắn từng khẩu."><title>${escape(title)} · Wardogs Docs</title><link rel="stylesheet" href="${prefix}assets/styles.css"></head><body>${header(prefix)}${body}${script}</body></html>`;}
